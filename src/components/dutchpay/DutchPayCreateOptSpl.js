...
const DutchPayCreateOptSpl = ({ dutchPay, dtAmt, dtDtlAmt, rmd, onChangeDtAmt }) => {
    return (
        <OptSecContainer>
            {dutchPay.dutchPayDtlFindInfoList?.map((info, index) => (
                <DutchPayDtl key={info.mbrId}>
                    ...
                    <div className="dt-container">
                        <div className="main-dt-container">
                            <div className="dt-value">{dtDtlAmt}</div>
            ...
            <div className="sum-container">
                ...
                <div className="sum-value">
                    <input className="sum-amt" onChange={onChangeDtAmt} value={dtAmt} type="number" />
