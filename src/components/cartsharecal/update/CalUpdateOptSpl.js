...
const CalUpdateOptSpl = ({ cartShareCal, splInput, onChangeSplInput }) => {
    return (
        <OptSplContainer>
            ...
            <div className="rmd">
                ...
                <div className="rmd-value">
                    <div className="rmd-amt">{splInput.calRmd.toLocaleString()}</div>
            ...
            <div className="sum">
                ...
                <div className="sum-value">
                    <input className="sum-amt" onChange={onChangeSplInput} value={splInput.calAmt.toLocaleString()} />
...
`;
export default CalUpdateOptSpl;
